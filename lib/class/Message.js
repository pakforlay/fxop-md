...
const { generateWAMessageFromContent, downloadContentFromMessage, generateWAMessage } = require("@whiskeysockets/baileys");
...
class Message extends Base {
	...
	// Helper method to check if the message is from a private chat
	isFromPrivateChat() {
